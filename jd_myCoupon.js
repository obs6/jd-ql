...
21 0,22 * * * jd_myCoupon.js, tag=测试, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
*/
const $ = new Env('我的测试');
            ...
            try {
                ...
                for (let i = 0; i < useable.length; i++) {
                    ...
                    if(useable[i].couponStyle==7){
                        message += `【白条券】===${useable[i].quota}-${useable[i].discount}() \n`;
