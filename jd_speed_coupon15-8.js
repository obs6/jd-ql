...
function exchange() {
    return new Promise(resolve => {
        console.log(`${JSON.stringify(taskUrl('functionId=lite_newBabelAwardCollection'))}`)
